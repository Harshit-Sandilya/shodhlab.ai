...
export default function Models() {
  return (
    <>
      <Navbar />
      {/* Card Blog */}
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto h-screen w-screen flex flex-col justify-evenly items-center">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
          {data.models.map((model) => (
            <div key={model.id} className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7] w-[90%]">
