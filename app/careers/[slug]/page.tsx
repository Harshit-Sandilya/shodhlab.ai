  ...
  return (
    <>
        ...
        <div className="flex items-center py-4">
          ...
          >
            ...
            <li
              ...
              aria-current="page"
            >
              {data.applicationSections[section].name}
            </li>
          </ol>
          {/* End Breadcrumb */}
        </div>
      ...
      >
        <div className="px-6">
          <Link
            className="flex-none text-xl font-semibold dark:text-white w-full h-auto"
            href="/"
            aria-label="Brand"
          >
            <Image
        ...
        >
          <ul className="space-y-1.5">
            {data.applicationSections.map((section, index) => (
              <li key={index}>
                <p
                  className="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 cursor-pointer"
