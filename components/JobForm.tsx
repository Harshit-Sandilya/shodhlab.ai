...
const JobForm: FC<IProps> = ({ role }) => {
	...
	return (
		<div className='flex flex-col gap-4 my-4 border rounded-lg lg:my-0 border-neutral-700 bg-neutral-900'>
			...
			>
				<label htmlFor='full_name' className='my-2 text-neutral-500'>
					Full name
				</label>
				<input
					type='text'
				...
				<label htmlFor='description' className='my-2 text-neutral-500'>
				...
				<label htmlFor='projects' className='my-2 text-neutral-500'>
					Provide a few links of any projects that you have worked on
				</label>
				<textarea
					rows={4}
					name='projects'
